 ...
 * @propType {object} [resultsState] - Use this to inject the results that will be used at first rendering. Those results are found by using the `findResults` function. Useful for [Server Side Rendering](guide/Server-side_rendering.html). 
 * @example
